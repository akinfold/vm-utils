...
sudo -u $PROJECT_USER_NAME sed -i "s/{{ PROCUSTODIBUS_DB_ALEK_1 }}/$PROCUSTODIBUS_DB_ALEK_1/g" "$API_ENV"
sudo -u $PROJECT_USER_NAME sed -i "s/{{ PROCUSTODIBUS_DB_USER_PASSWORD }}/$PROCUSTODIBUS_DB_USER_PASSWORD/g" "$API_ENV"
sudo -u $PROJECT_USER_NAME sed -i "s/{{ PROCUSTODIBUS_SIGNUP_KEY }}/$PROCUSTODIBUS_SIGNUP_KEY/g" "$API_ENV"
...
sudo -u $PROJECT_USER_NAME sed -i "s/{{ PROCUSTODIBUS_MAIL_RELAY_USERNAME }}/$PROCUSTODIBUS_MAIL_RELAY_USERNAME/g" "$API_ENV"
sudo -u $PROJECT_USER_NAME sed -i "s/{{ PROCUSTODIBUS_MAIL_RELAY_PASSWORD }}/$PROCUSTODIBUS_MAIL_RELAY_PASSWORD/g" "$API_ENV"
